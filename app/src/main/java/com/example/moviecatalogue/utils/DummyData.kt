...
object DummyData {
    ...
    fun generateDummyDataMovie(): ArrayList<Content> {
        val listMovies = ArrayList<Content>()
        ...
        listMovies.add(
            Content(
                ...
                imagePath = "poster_cold_persuit.jpg"
            )
        )
        ...
        listMovies.add(
            Content(
                ...
                imagePath = "poster_how_to_train.jpg"
            )
        )
        ...
        listMovies.add(
            Content(
                ...
                imagePath = "poster_infinity_war.jpg"
            )
        )
    ...
    fun generateDummyDataTvShow(): ArrayList<Content> {
        val listTvShows = ArrayList<Content>()
        ...
        listTvShows.add(
            Content(
                ...
                imagePath = "poster_doom_patrol.jpg"
            )
        )
        ...
        listTvShows.add(
            Content(
                ...
                imagePath = "poster_fairytail.jpg"
            )
        )
        ...
        listTvShows.add(
            Content(
                ...
                imagePath = "poster_family_guy.jpg"
            )
        )
        ...
        listTvShows.add(
            Content(
                ...
                releaseDate = "27/03/2005",
                imagePath = "poster_grey_anatomy.jpg"
            )
        )
        ...
        listTvShows.add(
            Content(
                ...
                imagePath = "poster_iron_fist.jpg"
            )
        )
